...
const cn = {
  WIP: "该功能仍在开发中……",
  Error: {
    Unauthorized: "请到公众号「**大灰指北**」回复「**密码**」免费获取密码，获取密码后在设置中输入密码后即可使用。嫌麻烦的也可以前往购买APIkey使用，购买地址：http://shop.zbooks.top",
  },
  ChatItem: {
  ...
  Settings: {
    ...
    Token: {
      Title: "API Key",
      SubTitle: "使用自己的 Key 可绕过密码访问限制，购买ApiKey：shop.zbooks.top",
